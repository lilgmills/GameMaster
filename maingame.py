...
from Logicstate import size, black, white, background, width, height, TILESIZE, TILEMAP_W, TILEMAP_H, Camera, Player, Logicstate
...
def main():
    ...
    worldmap_array = tmapc.creator('data/region-2.png')
    ...
    while True:
        ...
        C.DrawRender(screen, main_guy, Tmap)
